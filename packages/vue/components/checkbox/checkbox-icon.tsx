...
export default defineComponent({
  ...
  setup(props, { attrs }) {
    return () => (
      <>
        {props.checked ? (
          <svg {...attrs} viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
            ...
            />
            <path d="M16 3L7.72491 11L5 8" stroke={'var(--primary-background)'} stroke-width="1.5" />
          </svg>
        ) : (
          <svg {...attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" fill="none">
            <path
